  ...
  return (
    <>
      <div className="container">
        ...
        <div className="spon">
          <img src="./img/1sp.png" alt="spon" />
          <img src="./img/2sp.png" alt="spon" />
          <img src="./img/3sp.png" alt="spon" />
          <img src="./img/4sp.png" alt="spon" />
          <img src="./img/5sp.png" alt="spon" />
        </div>
          ...
          <div className="geolog">
            <div className="geo">
              ...
              <div className="rok">
                ...
                <p>
                  Tempat pariwisata yang populer <br />
            ...
            <div className="geog">
              ...
              <div className="rok">
                ...
                <p>
                  Tempat favorit dan disukai semua <br />
            ...
            <div className="geog">
              ...
              <div className="rok">
                ...
                <p>
                  Spot yang paling ramai dikunjungi <br />
